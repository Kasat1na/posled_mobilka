...
fun Board3(navController: NavHostController) {
    Column (
        ...
        Row (
            ...
            TextButton(onClick = { navController.navigate("Board4") }) {
        ...
        Column (
            ...
            {
                Image(painter = painterResource(id = R.drawable.k2), contentDescription = "", contentScale = ContentScale.FillWidth, modifier = Modifier.width(263.dp))
            }
        }
    }
}